...
if($result){
  ...
  if($num>0){
    ...
    $invalid=1;
    // echo " Your username or password could not be verified. Please try again.";
  ...
  <body>
    ...
    <?php
      if ($invalid){
        ...
        <strong>Oh dear.</strong> Your username and password could not be verified. Please try again.
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
          <span aria-hidden="true">&times;
          </span>
        </button>
    ...
    <div class="signup">
        <a href="sign.php" class="btn btn-primary mt-5 w-100"> Sign up </a>
    </div>
      </form>
    </div>
